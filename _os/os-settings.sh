...
# COMMON VARIABLES
# ------------------------------------------------------------------------------
if [[ -s ${DOT_DOTFILES}/_os/common/common.sh ]]; then
    source ${DOT_DOTFILES}/_os/common/common.sh
fi
...
if [[ ${OS_TYPE} == "Linux" ]]; then
    ...
    if [[ -s ${DOT_DOTFILES}/_os/unix/unix.sh ]]; then
        source ${DOT_DOTFILES}/_os/unix/unix.sh
    fi
